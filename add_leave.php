...
if(isset($_POST['submit'])){
	...
	$sql="insert into `leave`(leave_id,leave_from,leave_to,employee_id,leave_description,leave_status,role,employee_name) values('$leave_id','$leave_from','$leave_to','$employee_id','$leave_description',1,'$role','$employee_name')";
