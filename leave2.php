...
if($_SESSION['ROLE']==1){ 
$sql="select `leave`.*, employee.name,employee.role as role  from `leave`,employee where `leave`.employee_id=employee.id   order by `leave`.id desc";
}else{
                              ...
                              <table class="table ">
                                 ...
                                 <tbody>
									...
									<tr>
									   ...
									   <?php
									   if($row['leave_status']==1){ ?>
									   <a href="leave2.php?id=<?php echo $row['id']?>&type=delete">Delete</a>
									   <?php } ?>
